...
public class CreaExcelMemoriasAutorizadas {
	...
	public HSSFWorkbook createWorkbook(List<MemoriaAutorizadaVO> listaMemorias) throws Exception {
        ...
        for(int i = 0; i < listaMemorias.size(); i++) {
            ...
            cellDatos.setCellStyle(datosCellStyle);
            cellDatos.setCellValue(new HSSFRichTextString(listaMemorias.get(i).getTipoAutorizacion()));        
        }      
        return wb;
    }
