...
public class EnviaSubmodulosAction extends ExpansionAction implements SessionAware, ParameterNameAware {
	...
	String submodulos = ServletActionContext.getRequest().getParameter("submodulos");

	try {
		HttpSession sesion = ServletActionContext.getRequest().getSession();
		sesion.setAttribute("submodulos", submodulos);
		}
		 catch (Exception e) {
