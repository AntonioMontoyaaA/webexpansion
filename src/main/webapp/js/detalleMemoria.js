		...
		if(data.codigo != 200) {
			...
			if(data.generales != undefined) {
				...
				if(data.generales.categoria == 'A') {
					$("#estrellasMd").html("<img class='estrellaPuntuacionDetalle' src='img/estrella.png'><img class='estrellaPuntuacionDetalle' src='img/estrella.png'><img class='estrellaPuntuacionDetalle' src='img/estrella.png'>");
				} else if(data.generales.categoria == 'B') {
					$("#estrellasMd").html("<img class='estrellaPuntuacionDetalle' src='img/estrella.png'><img class='estrellaPuntuacionDetalle' src='img/estrella.png'>");
				} else {
					$("#estrellasMd").html("<img class='estrellaPuntuacionDetalle' src='img/estrella.png'>");
				}
