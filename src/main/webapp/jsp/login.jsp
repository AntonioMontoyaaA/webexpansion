	...
	<div class="row center">
			<div class="col-lg-2 login">
				<br><br>
					...
					<div class="col-md-12">
						<input type="text" name="user" value="350517" class="form-control input_login" placeholder="User">
					</div>
						<div class="col-md-12 padding_pass">
							<input type="password" name="pass" value="350517" class="form-control input_login" placeholder="Password">
						</div>
					<br><br>
						<div class="center">
