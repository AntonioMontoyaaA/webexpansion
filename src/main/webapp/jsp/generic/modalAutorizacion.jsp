  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer" style="background: #C9C9C9; justify-content: center">
        <button type="button" class="btn" id="btnModalAutorizacion" style="width: 100px; height: 30px; background: #071B36; padding-top: 2px; cursor: pointer;color: #FFFFFF;">Aceptar</button>
